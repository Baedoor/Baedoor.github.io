  ...
  <table class="archives" width="60%" cellpadding="10px" align="center" border="solid 1px">
      <tr>
          <td width="40%">
                ...
                <p class="def" align="center"> Contributing to the browser, make sure to check:<br>
                                               <a href="https://baedoor.github.io/wcontr/_guidelines.html"> Contribution Terms </a><br>
                                               Implementation guidelines: <a href="https://baedoor.miraheze.org/wiki/Baedoor_Data_IDs"> IDs </a> |
                                                                          <a href="https://baedoor.miraheze.org/wiki/Asset_folders%27_structure"> Folders </a> |
                                                                          <a href="https://baedoor.miraheze.org/wiki/Leveled_Lists"> Leveled Lists </a><br>
                                                                          <a href="https://baedoor.github.io/files/docs/design/Baedoor (3D) Development Doc.pdf"> 🪔 </a>
          </td>
          <td width="60%">
